`ifndef PCIE_GEN5_6_EQUALIZATION_TEST_SV
`define PCIE_GEN5_6_EQUALIZATION_TEST_SV

class pcie_gen5_6_equalization_test extends pcie_gen5_6_base_test;
  `uvm_component_utils(pcie_gen5_6_equalization_test)

  function new(string name = "pcie_gen5_6_equalization_test", uvm_component parent = null);
  ...
  endtask
endclass : pcie_gen5_6_equalization_test
