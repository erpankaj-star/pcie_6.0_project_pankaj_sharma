`ifndef PCIE_GEN5_6_REPLAY_ACK_NAK_TEST_SV
`define PCIE_GEN5_6_REPLAY_ACK_NAK_TEST_SV

class pcie_gen5_6_replay_ack_nak_test extends pcie_gen5_6_base_test;
  `uvm_component_utils(pcie_gen5_6_replay_ack_nak_test)

  function new(string name = "pcie_gen5_6_replay_ack_nak_test", uvm_component parent = null);
  ...
  endtask
endclass : pcie_gen5_6_replay_ack_nak_test
