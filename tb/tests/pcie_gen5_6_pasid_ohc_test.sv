`ifndef PCIE_GEN5_6_PASID_OHC_TEST_SV
`define PCIE_GEN5_6_PASID_OHC_TEST_SV

class pcie_gen5_6_pasid_ohc_test extends pcie_gen5_6_base_test;
  `uvm_component_utils(pcie_gen5_6_pasid_ohc_test)

  function new(string name = "pcie_gen5_6_pasid_ohc_test", uvm_component parent = null);
  ...
  endtask
endclass : pcie_gen5_6_pasid_ohc_test
